        ...
        <div className="flex justify-center items-center">
            <form className="w-2/3">
                ...
                <div className="flex w-full mt-4">
                    <div className="w-1/2 flex flex-col pl-80">
                        {categories.map(category => <button
                            className="rounded-r-2xl bg-red-400"
                            onClick={e => moveToChosen(e, category)}
                        >{category.name}</button>)}
                    </div>
                    <div className="w-1/2 flex flex-col pr-80">
                        {chosenCategories.map(category => <button
                            className="rounded-l-2xl bg-red-400">{category.name}</button>)}
                    </div>
                </div>
            </form>
        </div>
